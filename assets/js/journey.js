...
(function () {
  ...
  var MAP = [
    ...
    [/^\/(learn|explorables|notes)(\/|$)/, { href: "/build/", t: "Try making your own",
      s: ["Feeling a bit braver now? Have a go at building a little AI helper of your very own — we'll walk you through every step.",
          "Feeling braver? Build a little AI helper of your own.",
          "Build your own helper."] }],
    [/^\/build(\/|$)/, { href: "/products/", t: "Or use one we made",
      s: ["Don't fancy building it all yourself? That's completely fine — come and meet the ready-made helpers we've already built for you.",
          "Not in the mood to build? Meet our ready-made helpers.",
          "Or use a ready-made helper."] }],
